...
**Протеин + гарнир (чередование):** в 👪 Семья есть отдельное окно «🍱 Протеин + гарнир» — семья описывает раздельно гарниры (макароны, картошка, гречка, перловка, овсянка, киноа, тушёная капуста…) и виды белка (наггетсы, котлеты, рагу из мяса или бобов, стейки из рыбы…). Кнопка «✨ Собрать комбинации» через GPT раскладывает описание на два списка компонентов, а дальше **детерминированный код** (`js/combo.js`) собирает допустимые пары и материализует их как регулярные рецепты «Белок + гарнир» — так планировщик уже умеет их ротировать, считать покупки/КБЖУ и печатать. Правила сочетаемости (заданы владельцем, зашиты в код с тестами): рыба/морепродукты **не** идут с пастой; бобовым нужны овощи, **а не** крупы/картошка (сама бобовая часть — уже крахмал+белок). Сборка «на разнообразие»: жадно чередует и белок, и гарнир по конкретным блюдам и категориям, без повторов подряд; классификация компонента по названию (крахмал/овощ, класс белка) работает и когда GPT не проставил категорию. Поле «Комбинаций» ограничивает количество (иначе все допустимые пары).
