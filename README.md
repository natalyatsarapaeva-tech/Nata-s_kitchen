...
- **`nutrition/{canonicalName}`** — справочник ингредиентов (глобальный, факты):
  `{ kcal, protein, fat, carbs, fiber?, potassium?, phosphorus?, unitG?, aliases?[], category?, isPantryStaple?, perishability?, storage? }` на 100 г. Клетчатка (г), калий и фосфор (мг) — опциональны, заполняются «Обогатить»/«Узнать»; нужны для диабет/почечных семей.
