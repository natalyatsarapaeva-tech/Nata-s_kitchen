...
**Замены продуктов и микроэлементы (диабет/почки):** в 👪 Семья семья задаёт правила замен `продукт → замена` (мука → цельнозерновая, сахар → эритрит, белый рис → бурый). Замены — **слой поверх общей книги** (`substitute.js`): в карточке рецепта, расчёте КБЖУ и списке покупок продукт показывается заменённым (с пометкой «↺ вместо…»), но сам рецепт в общей книге не меняется — у других семей он прежний, редактор всегда правит оригинал. Чекбокс «показывать клетчатку/калий/фосфор» выводит на панель КБЖУ чистые углеводы (углеводы − клетчатка), калий и фосфор на порцию; «≥» означает, что часть ингредиентов без данных и сумма неполная. Справочник обогащается этими полями через «🏷️ Обогатить»/«✨ Узнать».
